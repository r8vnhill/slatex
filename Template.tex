...
\documentclass{article}
  ...
  \setup { 
    title = {A Heuristic Proof on the Non-Deterministic Behaviour of the \textit{Little Room}'s Printer},
...
\begin{document}
  ...
  \tableofcontents
  \newpage
  \import{contents}{Introduction__or_Why_I_Created_this_Template.tex}
  \import{contents}{Quickstart.tex}
  \import{contents}{Changing_the_Default_Titles.tex}
